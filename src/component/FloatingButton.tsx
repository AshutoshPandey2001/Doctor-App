...
const FloatingButton = ({ navigation }: any) => {
    ...
    return (
        <>
            <Pressable style={{ position: 'absolute', bottom: 100, right: 16, backgroundColor: '#2a7fba', padding: 16, borderRadius: 50 }} onPress={() => addPatients()}>
                                    ...
                                    <View>
                                        ...
                                        <View style={styles.section}>
                                            ...
                                            <View style={[
                                                ...
                                                <CustomSearchAutocomplete data={allPatients.patients} searchKey="pName" onSelect={handleItemSelect} placeHolder={'Enter Patient Name'} value={values.pName} setValue={setValue} />
                                            </View>
                                        ...
                                        <View style={styles.section}>
                                            ...
                                            <View style={[
                                                ...
                                                <CustomSearchAutocomplete data={allPatients.patients} searchKey="pMobileNo" onSelect={handleItemSelect} placeHolder={'Enter Mobile Number'} value={values.pMobileNo} setValue={setValue} />
                                            </View>
